...
//         .showBottomSheet((context) => Text(error.toString()));
...
//                     (context) => Text('Received ${source.sourceId}'));
...
//                   .then((paymentMethod) {
//                 _scaffoldKey.currentState.showBottomSheet(
//                     (context) => Text('Received ${paymentMethod.id}'));
//                 // _scaffoldKey.currentState.showSnackBar(
...
//               ).then((token) {
//                 _scaffoldKey.currentState.showBottomSheet(
//                     (context) => Text('Received ${token.tokenId}'));
//                 // _scaffoldKey.currentState.showSnackBar(
...
//                 _scaffoldKey.currentState.showBottomSheet(
//                     (context) => Text('Completed successfully'));
